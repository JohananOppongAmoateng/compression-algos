...
[![shipthatcode — Build Your Own Compression Algorithm](https://api.shipthatcode.com/cert/2c80c1f8a94d519f2455471afdd37a29.svg)](https://shipthatcode.com/courses/build-compression)

My working repo for [Build Your Own Compression Algorithm](https://shipthatcode.com/courses/build-compression) on [shipthatcode.com](https://shipthatcode.com) — built lesson by lesson in my own editor.
...
3. In your terminal, inside the unzipped folder, push it to GitHub:
   ...
   git init
   git add .
   git commit -m "start Build Your Own Compression Algorithm"
   git branch -M main
   git remote add origin https://github.com/YOUR-USERNAME/YOUR-REPO.git
   git push -u origin main
   ```

4. Paste your repo link on the [course page](https://shipthatcode.com/courses/build-compression) ("Work in your own editor" → **Link repo**). Done — you never do this again.
